...
{
$errormsg = "<div class='alert alert-success'><strong>Success!</strong> Campus Add successfully</div>";
}else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="2")
{
$errormsg = "<div class='alert alert-success'><strong>Success!</strong> Campus Edit successfully</div>";
}
else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="3")
{
$errormsg = "<div class='alert alert-success'><strong>Success!</strong> Campus Delete successfully</div>";
}
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Campus  
						<?php
...
?>
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-primary">
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Campus </label>
								<div class="col-sm-10">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Password"> ID  </label>
								<div class="col-sm-10">
		...
		$( document ).ready( function () {			
			 ...
			 if($("#signupForm1").length > 0)
         {
			$( "#signupForm1" ).validate( {
				...
				messages: {
					branch: "Please enter Campus name",
					address: "Please enter ID"
                             ...
                             <div class="table-sorting table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
									...
									echo '<tr>
                                            ...
                                            <td>'.$r['detail'].'</td>
											<td>
											<a href="branch.php?action=edit&id='.$r['id'].'" class="btn btn-success btn-xs">Edit <span class="glyphicon glyphicon-edit"></span></a>
											
											<a onclick="return confirm(\'Are you sure you want to delete this record\');" href="branch.php?action=delete&id='.$r['id'].'" class="btn btn-danger btn-xs">Delete <span class="glyphicon glyphicon-remove"></span></a> </td>
                                        </tr>';
										$i++;
									}
									?>
    ...
    <div id="footer-sec">
	School Fees Payment System | Brought To You By Waqas Maqbool
    </div>
