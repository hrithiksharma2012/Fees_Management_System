...
$branch = mysqli_real_escape_string($conn,$_POST['branch']);
 ...
 $conn->query("INSERT INTO  fees_transaction (stdid,paid,submitdate,transcation_remark) VALUES ('$sid','$advancefees','CURRENT_DATE()','$remark')") ;
 ...
 $id = mysqli_real_escape_string($conn,$_POST['id']);	
   $sql = $conn->query("UPDATE  student  SET  branch  = '$branch',joindate='$joindate', contact  = '$contact', sname = '$sname' WHERE  id  = '$id'");
...
?>
		...
		?>
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-primary">
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">GR* </label>
								<div class="col-sm-10">
                            ...
                            <div class="table-sorting table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
									...
									echo '<tr '.(($r['balance']>0)?'class="danger"':'').'>
											...
											<a href="student.php?action=edit&id='.$r['id'].'" class="btn btn-success  btn-xs">Edit <span class="glyphicon glyphicon-edit"></span></a>
											
											<a onclick="return confirm(\'Are you sure you want to delete this record\');" href="student.php?action=delete&id='.$r['id'].'" class="btn btn-danger btn-xs">Delete <span class="glyphicon glyphicon-remove"></span></a> </td>
                                    ...
                                    <button class="btn btn-danger  pull-right" onclick="window.print()">Print  <span class="glyphicon glyphicon-print"></span></button>
                                </table>
                            </div>
                        </div>
                    </div>
    ...
    <div id="footer-sec">
	School Fees Payment System | Brought To You By :WaqasMaqbool
    </div>
